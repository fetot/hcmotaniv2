...
<div id="content">
  ...
  <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    <div class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100">
      <h1 class="h5 mb-0 text-gray-800">Info Karyawan [<?php echo $tabel['id_karyawan']; echo " / "; echo $tabel['nama'];echo " / ";echo $tabel['bagian']; ?>] <span class="text-danger font-weight-bold">(Sudah Resign)</span></h1>
    </div>
    ...
    <li class="nav-item dropdown no-arrow mx-1">
              ...
              <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                ...
                <a class="dropdown-item d-flex align-items-center" href="ubahkaryawanres?id=<?php echo $tabel['id_karyawan']; ?>">
                  <div class="mr-3">
