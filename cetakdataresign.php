...
<head>
  ...
  <title>Data Resign Karyawan Harlep PT. OTANI (<?php echo date('d-M-Y');?>)</title>
...
<div id="content">
  ...
  <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    <div class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100">
      <h1 class="h5 mb-0 text-gray-800">Cetak Data Karyawan Harlep yang Resign</h1>
    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-table fa-fw mr-2"></i>Data Resign (<?php echo date("d/m/Y"); ?>)</h6>
                                </div>
                    <div class="card-body">
