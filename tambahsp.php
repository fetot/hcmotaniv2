...
<div id="content">
  ...
  <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    <div class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
      <h1 class="h4 mb-0 text-gray-800">Tambah Surat Peringatan</h1>
    </div>
  ...
  <!-- Begin Page Content -->
                    <div class="container-fluid">
                        ...
                        <div class="card-header py-3">
                          <h6 class="m-0 font-weight-bold text-primary"><i class="fas fa-exclamation-triangle mr-2"></i>Surat Peringatan</h6>
                        </div>
                            <div class="card-body">
...
<table class="table table-sm table-borderless p-2">
  ...
  <tr>
    ...
    <tr>
        ...
        <td>
          <a href="" class="btn btn-warning mt-3 btn-icon-split" data-toggle="modal" data-target="#modalKonfirmasi">
                    <span class="icon text-white-50">
                      <i class="fas fa-exclamation-triangle"></i>
                    </span>
                    <span class="text">Beri SP</span>
                    </a>
        </td>
        <td></td>
